...
public class UpcPassDogadjajiItem {
    ...
    public UpcPassDogadjajiItem(String dataTitle, String dataDate, String dataTime, Bitmap dataImage, String eventTip, String eventDetail) {
