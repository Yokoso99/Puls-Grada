...
public class SalsaBar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salsa_bar);
        ...
        pogledaj_dogadjaje.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Intent intent = new Intent(SalsaBar.this, Dogadjaji.class);
